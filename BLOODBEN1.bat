...
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/raw/main/haha.mp3" -outfile "%appdata%\ren\heha.mp3"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/raw/main/benben.mp3" -outfile "%appdata%\ren\benben.mp3"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/raw/main/benhahalong.mp3" -outfile "%appdata%\ren\benbenlong.mp3"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/raw/main/benben.mp3" -outfile "%appdata%\ren\benben.mp3"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/nomalben.png?raw=true" -outfile "%appdata%\ren\nomalben.png"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/haha.jpg?raw=true" -outfile "%appdata%\ren\back.jpg"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/bigfacebenright.PNG?raw=true" -outfile "%appdata%\ren\benangry.jpg"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/bigfacebenmid.png?raw=true" -outfile "%appdata%\ren\benangry1.jpg"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/bigfacebenleft.PNG?raw=true" -outfile "%appdata%\ren\benangry2.jpg"

powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/1(1).png?raw=true" -outfile "%appdata%\ren\1.png"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/2.png?raw=true" -outfile "%appdata%\ren\2.png"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/3.png?raw=true" -outfile "%appdata%\ren\3.png"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/4.png?raw=true" -outfile "%appdata%\ren\4.png"
powershell -Command "Invoke-Webrequest" "https://github.com/uzokingkong/bloodben/blob/main/blak.png?raw=true" -outfile "%appdata%\ren\black.png"
